/*
  ...
  gengetopt --input=strmasc2bin.ggo --unamed-opts 
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -v, --verbose        add some more output  (default=off)",
  "  -o, --output=STRING  name of the output file, no extensions",
    0
};
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVqvo:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'v':	/* add some more output.  */
          ...
          break;
        case 'o':	/* name of the output file, no extensions.  */
